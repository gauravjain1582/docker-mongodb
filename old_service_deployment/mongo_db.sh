...
# Lable Mongo hosts
docker node update --label-add mongodb.rhost=1 $(docker node ls -q -f name=master)
...
# host 1
docker volume create --name mongodb_datav1
docker volume create --name mongodb_configv1
# host 2
# docker volume create --name mongodb_datav2
# docker volume create --name mongodb_configv2
# host 3
ssh  docker volume create --name mongodb_datav3
 docker volume create --name mongodb_configv3
...
--constraint 'node.labels.mongodb.rhost == 2' \
